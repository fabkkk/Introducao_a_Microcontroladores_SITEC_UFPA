...
Após a parte teórica, os conceitos são aplicados em projetos práticos utilizando o **ESP32**, permitindo que os participantes compreendam, na prática, como um microcontrolador pode receber informações, processá-las e realizar ações no mundo físico.
...
**Projeto no Wokwi:**
[Link do projeto]([LINK_DO_WOKWI](https://wokwi.com/projects/473515091996013569))
